...
export const en = {
  ...
  lifecycle: {
    ...
    fieldsLabel: 'What this stage expects attached',
    fieldsPlaceholder: 'ci, runbook, design\u2026',
    fieldsHint: 'Offered first when attaching here, and told to agents so they use one name for one field. Anything else is still accepted.',
