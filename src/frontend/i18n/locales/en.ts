...
export const en = {
  ...
  lifecycle: {
    ...
    belongsAuto: 'Arrives by itself',
    belongsHand: 'Someone attaches it',
    belongsAutoHint: 'Read from somewhere else and kept current \u2014 you never touch it here. Switch one off to keep it off this stage.',
    belongsHandHint: 'Nothing can fetch these, so a person or an agent attaches them. The names listed here are this project\u2019s agreed vocabulary for that: they are handed to agents through the MCP and offered first when attaching, so one field keeps one name. Advisory \u2014 anything attached shows whether or not it is listed.',
    belongsHint: 'One difference between the rows: an automatic one switches off, an attached name does not \u2014 what is attached shows whether or not it is listed here.',
